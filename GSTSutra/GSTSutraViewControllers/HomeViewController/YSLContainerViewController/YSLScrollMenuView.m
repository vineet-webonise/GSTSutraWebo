...
static const CGFloat kYSLScrollMenuViewWidth  = 90 + 10;
static const CGFloat kYSLScrollMenuViewMargin = 20;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // default
        _viewbackgroudColor = [UIColor colorWithRed:42/255.0 green:49/255.0 blue:73/255.0 alpha:1.0];
        _itemfont = [UIFont fontWithName:centuryGothicBold size:titleFont];
        //_itemTitleColor = [UIColor colorWithRed:42/255.0 green:86/255.0 blue:99/255.0 alpha:1.0];
        ...
        _scrollView.backgroundColor = _viewbackgroudColor;
...
- (void)setItemTitleArray:(NSArray *)itemTitleArray
{
    if (_itemTitleArray != itemTitleArray) {
        ...
        _indicatorView.frame = CGRectMake(17, _scrollView.frame.size.height - kYSLIndicatorHeight, kYSLScrollMenuViewWidth , kYSLIndicatorHeight);
