...
- (void)viewDidLoad {
    ...
    if (_isFromSearch) {
        _contentScrollView.frame = CGRectMake(0,_topBarHeight, self.view.frame.size.width, self.view.frame.size.height - (_topBarHeight + kYSLScrollMenuViewHeight));
    } else {
    ...
    _contentScrollView.backgroundColor = [UIColor colorWithRed:42/255.0 green:49/255.0 blue:73/255.0 alpha:1.0];
    _contentScrollView.pagingEnabled = YES;
    _contentScrollView.delegate = self;
    _contentScrollView.showsHorizontalScrollIndicator = NO;
    _contentScrollView.scrollsToTop = NO;
    [self.view addSubview:_contentScrollView];
    _contentScrollView.contentSize = CGSizeMake(self.view.frame.size.width * self.childControllers.count, _contentScrollView.frame.size.height);
    ...
    if (self.isFromSearch) {
        _menuView = [[YSLScrollMenuView alloc]initWithFrame:CGRectMake(0,44, self.view.frame.size.width, kYSLScrollMenuViewHeight)];
    } else {
    ...
    _menuView.backgroundColor = [UIColor colorWithRed:42/255.0 green:49/255.0 blue:73/255.0 alpha:1.0];
